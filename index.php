...
<head>
  ...
  <!-- Web Icon -->
  <link rel="shortcut icon" type="image/x-icon" href="img/dosen.png">
...
<body id="page-top">
  ...
  $result_mahasiswa = mysqli_query($connection, "SELECT * FROM mahasiswa, program_studi where mahasiswa.id_prodi = program_studi.id_prodi ORDER BY nrp ASC");
  ?>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal1">
            ...
            <img class="img-fluid" src="img/dosen.png" alt="">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal2">
            ...
            <img class="img-fluid" src="img/mahasiswa.png" alt="">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal3">
            ...
            <img class="img-fluid" src="img/matakuliah.png" alt="">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal5">
            ...
            <img class="img-fluid" src="img/jadwalkuliah.png" alt="">
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4">
          <div class="portfolio-item mx-auto text-center" data-toggle="modal" data-target="#portfolioModal6">
            ...
            <img class="img-fluid" src="img/dokumen.png" alt="">
          </div>
        </div>
                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                      ...
                      while ($data_mahasiswa = mysqli_fetch_array($result_mahasiswa)) {
                        ...
                        echo "<td>".$data_mahasiswa['nama_prodi']."</td>";
                        echo "<td> <a class='btn btn-success' href='edit_mhs.php?nrp=$data_mahasiswa[nrp]'>Edit</a> <a class='btn btn-danger' onclick = 'deleteConfirm(event)' href='delete_mhs.php?nrp=$data_mhs[nrp]'><i class='fas fa-trash fa-fw'></i>Delete</a></td></tr>";
                      }
                        ?>
                    </tbody>
                  </table>
