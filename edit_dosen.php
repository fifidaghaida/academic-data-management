                        ...
                        <form action="edit_dosen.php" method="post" >
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>NIP</label>
                                    <input class="form-control" id="nip" name="nip" type="text" value='<?php echo $nip; ?>' requied="required">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" name="update" values="Update" class="btn btn-primary btn-x1"></input>
